...
import 'package:transpo_track/common/widgets/Icons/t_circular_icon.dart';
...
import 'package:transpo_track/common/widgets/texts/feature_n_text.dart';
import 'package:transpo_track/common/widgets/texts/feature_title_text.dart';
          ...
          children: [
            ...
            TRoundedContainer(
              ...
              child: Stack(
                children: [
                  // -- Thumbail image
                  const TRoundedImage(imageUrl: TImages.carro1, applyImageRadius: true),
                  ...
                  const Positioned(
                    top: 0,
                    right: 0,
                    child: TCircularIcon(icon: Iconsax.check, color: Colors.red)
                  ),
            ...
            const Padding(
              ...
              child: Column(
                ...
                children: [
                  TProductTitleText(title: 'Holaaa', smallSize: true,),
